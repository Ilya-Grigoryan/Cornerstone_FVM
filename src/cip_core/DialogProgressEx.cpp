//  DialogProgressEx.cpp : implementation file
...
CDialogProgressEx::CDialogProgressEx(UINT nCaptionID)
{
    ...
    m_nUpper=100;
    m_nStep=10;
    //{{AFX_DATA_INIT(CDialogProgressEx)
    // NOTE: the ClassWizard will add member initialization here
    //}}AFX_DATA_INIT
    m_bParentDisabled = FALSE;
}

CDialogProgressEx::~CDialogProgressEx()
{
    if(m_hWnd!=NULL)
      DestroyWindow();
}

BOOL CDialogProgressEx::DestroyWindow()
{
    ReEnableParent();
    return CDialog::DestroyWindow();
}

void CDialogProgressEx::ReEnableParent()
{
...
BOOL CDialogProgressEx::Create(CWnd *pParent)
{
    ...
    if(!CDialog::Create(CDialogProgressEx::IDD, pParent))
    {
      ReEnableParent();
      return FALSE;
    }
...
void CDialogProgressEx::DoDataExchange(CDataExchange* pDX)
{
    CDialog::DoDataExchange(pDX);
    //{{AFX_DATA_MAP(CDialogProgressEx)
    DDX_Control(pDX, CG_IDC_PROGDLG_PROGRESS, m_Progress);
    //}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CDialogProgressEx, CDialog)
    //{{AFX_MSG_MAP(CDialogProgressEx)
    //}}AFX_MSG_MAP
END_MESSAGE_MAP()

void CDialogProgressEx::SetStatus(LPCTSTR lpszMessage)
{
...
void CDialogProgressEx::OnCancel()
{
    m_bCancel=TRUE;
}

void CDialogProgressEx::SetRange(int nLower,int nUpper)
{
    m_nLower = nLower;
    m_nUpper = nUpper;
...
int CDialogProgressEx::SetPos(int nPos)
{
    PumpMessages();
...
int CDialogProgressEx::SetStep(int nStep)
{
    m_nStep = nStep; // Store for later use in calculating percentage
    return m_Progress.SetStep(nStep);
}

int CDialogProgressEx::OffsetPos(int nPos)
{
    PumpMessages();
...
void CDialogProgressEx::PumpMessages()
{
...
BOOL CDialogProgressEx::CheckCancelButton()
{
...
void CDialogProgressEx::UpdatePercent(int nNewPos)
{
...
/////////////////////////////////////////////////////////////////////////////
// CDialogProgressEx message handlers

BOOL CDialogProgressEx::OnInitDialog() 
{
